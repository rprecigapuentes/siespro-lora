...
import tty
import os
import time  # para controlar la tasa de muestreo

# Configuración del puerto serie
PORT = "/dev/ttyUSB0"
BAUD = 115200          # debe coincidir con Serial.begin(115200)
    ...
    try:
        with serial.Serial(PORT, BAUD, timeout=1) as ser, \
            ...
            while True:
                ...
                # Esperamos formato: temp,hum_aire,rssi,snr
                partes = linea.split(",")
                if len(partes) != 4:
                ...
                writer.writerow([timestamp, temp, hum_aire, rssi, snr, label])
                f.flush()
